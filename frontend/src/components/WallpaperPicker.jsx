  ...
  return (
    <button
      ...
      className={[
        ...
        'focus-visible:ring-primary focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-offset-[#2a2a2c]',
      ].join(' ')}
    ...
    >
      <img
        ...
        draggable={false}
      />
      <span className='pointer-events-none absolute inset-x-0 bottom-0 z-10 bg-black/55 px-2 py-1.5 text-left text-[11px] leading-tight font-medium text-white/95'>
        {wallpaper.label}
      </span>
      {selected ? (
        <span className='absolute top-1.5 right-1.5 z-10 flex size-6 items-center justify-center rounded-full bg-white text-[#1a1a1c] shadow-md'>
          <Check
            className='size-3.5'
            strokeWidth={3}
          />
    ...
    <Modal.Root state={modal}>
      ...
      <Modal.Backdrop variant='opaque'>
        <Modal.Container
          ...
          placement='center'
        >
          <Modal.Dialog className='text-foreground max-h-[85dvh] border border-white/10 bg-[#2a2a2c] shadow-2xl'>

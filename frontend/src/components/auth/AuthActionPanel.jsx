      ...
      <AuthCardShell>
        <div className='mb-8 flex flex-col items-center text-center'>
          <div className='relative mb-5'>
            <div
              aria-hidden
              className='from-accent/22 via-accent/8 dark:from-accent/28 dark:via-accent/10 absolute -inset-3.5 rounded-[20px] bg-linear-to-br to-transparent opacity-90 blur-xl'
            />
          ...
          <div className='text-accent flex items-center justify-center gap-1.5'>
            <SparklesIcon
              className='size-3.5'
              strokeWidth={2}
              aria-hidden

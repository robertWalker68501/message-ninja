...
export function AuthHeroPanel() {
  return (
    <section className={heroPanelClassName}>
      ...
      <div className='relative z-1 flex flex-1 flex-col px-6 pt-8 pb-6 md:px-8 md:pt-10 md:pb-8'>
        <div className='text-center md:text-left'>
          <p className='mb-2.5 font-mono text-[10px] font-semibold tracking-[0.28em] text-zinc-500 uppercase dark:text-[#636366]'>
            Secure gateway
          </p>
          <h2 className='font-mono text-[1.15rem] leading-snug font-semibold tracking-[0.06em] text-balance text-zinc-900 uppercase sm:text-[1.25rem] dark:text-white'>
            Open {APP_NAME}
          </h2>
          <p className='mx-auto mt-2.5 max-w-[22rem] font-mono text-[11px] leading-relaxed font-medium tracking-wide text-pretty text-zinc-600 md:mx-0 md:max-w-none dark:text-[#98989D]'>
        ...
        <p className='text-center font-mono text-[10px] font-medium tracking-[0.18em] text-zinc-500 uppercase md:text-left dark:text-[#636366]'>

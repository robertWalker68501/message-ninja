                  ...
                  return (
                    <button
                      ...
                      className={[
                        ...
                        selected
                          ? 'ring-accent bg-white/10 ring-2 ring-offset-2 ring-offset-[#2a2a2c]'
                          : 'hover:bg-white/6',
                      ].join(' ')}
                    ...
                    >
                      <span className='relative'>
                        ...
                        {selected ? (
                          <span className='bg-accent text-accent-foreground absolute -top-0.5 -right-0.5 flex size-5 items-center justify-center rounded-full shadow-md'>
                            <Check
                              className='size-3'
                              strokeWidth={3}
                            />
